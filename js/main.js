class Player {
    ...
    toggleFullscreen() {
        ...
        if (!full) {
            ...
            panelLine.style = `max-width:none`
        }


        else {
            document.exitFullscreen();
            panel.style = `max-width:1177px;`
        }
    ...
    setVideoLine(event) {
        ...
        const duration = Math.floor(this.video.duration); // 1353
...
var panelLine = document.querySelector('.panel-line');
